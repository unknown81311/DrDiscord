  ...
  return React.createElement(Menu.default, {
    ...
    children: [
      ...
      React.createElement(Menu.MenuItem, {
        ...
        children: [
          ...
          React.createElement(Menu.MenuItem, {
            ...
            subtext: "Hold shift to restart discord",
            action: ({ shiftKey }) => shiftKey ? ipcRenderer.invoke("RESTART_DISCORD") : location.reload()
          })
        ]
      }),
      React.createElement(Menu.MenuSeparator),
      React.createElement(Menu.MenuItem, {
        ...
        action: DrApi.customCSS.openPopout
      })
    ]
  })
})
...
const Button = React.memo(() => {
  ...
  return React.createElement(PanelButton.default, {
    icon: () => React.createElement("svg", {
        width: "22",
        height: "22",
        viewBox: "0 0 22 22",
