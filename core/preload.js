...
if (ipcRenderer.sendSync("APP_DID_CRASH")) return (() => {
  logger.error("DrDiscord:ELECTRON", "Discord has crashed before so DrDiscord will not load until Discord is restarted.")const { webFrame, ipcRenderer } = require("electron")
